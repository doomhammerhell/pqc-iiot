...
- [Usage Guide](usage.md)
  ...
  - [CoAP Integration](usage/coap.md)
- [Hardware Integration](hardware.md)
  - [HAL Internals (Architecture)](hardware/hal_internals.md)
...
- [Mathematical Foundations](crypto/math.md)
  - [Security Proofs & Reductions](crypto/proofs.md)
